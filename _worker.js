...
const serviceName = "vps"; // Ganti dengan nama workers kalian
const apiKey = "Qotg4054mlC2rshiNEtS-UvE61xUNsM_DEgLb-kTb"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
